...
public record NotNullWhenTestRequest(String property, String differentProperty) {

    public static class Condition implements Predicate<NotNullWhenTestRequest> {
        @Override
        public boolean test(NotNullWhenTestRequest notNullWhenTestRequest) {
            return "not null".equals(notNullWhenTestRequest.differentProperty());
        }
    }
}
