...
import net.croz.nrich.security.csrf.properties.CsrfProperties;
...
public class CsrfAutoConfiguration {
    ...
    @Bean
    public CsrfTokenManagerService tokenManagerService(final CsrfProperties csrfProperties) {
    ...
    @Bean
    public CsrfInterceptor csrfInterceptor(final CsrfTokenManagerService csrfTokenManagerService, final CsrfProperties csrfProperties) {
    ...
    @Bean
    public CsrfWebFilter webFilter(final CsrfTokenManagerService csrfTokenManagerService, final CsrfProperties csrfProperties) {
