...
## [FieldErrorMessageResolverService][field-error-message-resolver-service-url]
...
## [ConstrainedPropertyValidatorConverterService][constrained-property-validator-converter-service-url]

[`ConstrainedPropertyValidatorConverterService`][constrained-property-validator-converter-service-url] is a service responsible for converting constraints in a format the client can interpret.
...
[`FormConfigurationService`][form-configuration-service-url] is service that processes constraints defined on a class for form id list and returns a list of
[`FormConfiguration`][form-configuration-url] instances holding client side constrained property configuration.

---

## [FormConfigurationController][form-configuration-controller-url]
