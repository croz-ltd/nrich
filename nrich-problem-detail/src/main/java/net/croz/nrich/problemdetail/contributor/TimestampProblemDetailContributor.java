...
public class TimestampProblemDetailContributor implements ProblemDetailContributor, Ordered {

    @Override
    public void contribute(ProblemDetail problemDetail, ProblemDetailContributorContext context) {
        problemDetail.setProperty(ProblemDetailConstants.TIMESTAMP_PROPERTY, DateTimeFormatter.ISO_INSTANT.format(context.timestamp()));
    }

    @Override
    public int getOrder() {
        return ProblemDetailConstants.TIMESTAMP_CONTRIBUTOR_ORDER;
    }
