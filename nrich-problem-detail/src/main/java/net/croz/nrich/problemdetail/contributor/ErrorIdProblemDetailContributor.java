...
public class ErrorIdProblemDetailContributor implements ProblemDetailContributor, Ordered {

    @Override
    public void contribute(ProblemDetail problemDetail, ProblemDetailContributorContext context) {
        problemDetail.setProperty(ProblemDetailConstants.ERROR_ID_PROPERTY, context.correlationId());
    }

    @Override
    public int getOrder() {
        return ProblemDetailConstants.ERROR_ID_CONTRIBUTOR_ORDER;
    }
