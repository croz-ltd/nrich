 ...
 *
 * @param parentProperty Parent (root class) property name.
 * @param childProperty  Child property name.
 */
public record SearchPropertyJoin(String parentProperty, String childProperty) {
