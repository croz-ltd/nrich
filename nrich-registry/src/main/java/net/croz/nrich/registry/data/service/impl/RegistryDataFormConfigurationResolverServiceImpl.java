...
public class RegistryDataFormConfigurationResolverServiceImpl implements RegistryDataFormConfigurationResolverService {

    private final List<Class<?>> registryClassList;

    private final Map<String, Class<?>> formConfigurationMap;

    public RegistryDataFormConfigurationResolverServiceImpl(final List<Class<?>> registryClassList, final Map<String, Class<?>> formConfigurationMap) {
